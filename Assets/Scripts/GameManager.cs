...
using UnityEngine;
using UnityEngine.UI;           //½Ç¸°´õ ¾µ°Å¸é Àû¾î¾ßÇÔ
...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject SliderFill;     //½Ç¸°´õ °ÔÀÌÁö¸¦ Á¶ÀıÇÒ °ÔÀÓ¿ÀºêÁ§Æ® º¯¼ö

    void Awake()
    {
        if(instance == null)        //¾ÀÀ» ´Ù½Ã ºÒ·¯¿ÔÀ» ¶§ ÃÊ±âÈ­ ÇØÁÖ´Â ¿ªÇÒ
        {
    ...
    IEnumerator CountDownTimerRoutine()     //ÃÖ´ë½Ã°£¿¡¼­ÇöÀç
    {
        ...
        SliderFill.SetActive(false);        //0ÃÊ°¡ µÇ¸é ±×³É ½Ç¸°´õ °ÔÀÌÁö°¡ ºñÈ°¼ºÈ­µÇµµ·Ï ÀÏ´Ü ¼³Á¤
    ...
    public void Quit()
    {
        Application.Quit();     //ºôµå½Ã ¾ÛÀ» ²ø ¼ö ÀÖ°Ô ÇØÁÖ´Â Á¾·áÄÚµå Ãß°¡
    }
}
